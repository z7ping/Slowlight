...
class _HabitScreenState extends State<HabitScreen> {
  ...
  Future<void> _checkIn(Habit habit) async {
    ...
    try {
      final result = await ApiService.checkInHabit(habit.id, note: note ?? '', durationMin: durationMin ?? 0, period: period ?? '');
      if (mounted) {
      ...
      child: Column(
        ...
        children: [
          ...
          if (_expandedHabitLogs.isNotEmpty) ...[
            ...
            Text('最近打卡记录', style: TextStyle(
              fontSize: AppTheme.textMd, fontWeight: FontWeight.w600, color: AppTheme.warmDark,
            )),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text('$m-$d $h:$min', style: TextStyle(
                                fontSize: AppTheme.textMd, height: 1.5, fontWeight: FontWeight.w500, color: AppTheme.warmDark,
                              )),
                              if (dMin > 0) ...[
                                const SizedBox(width: 6),
                                Text('$dMin 分钟', style: TextStyle(
                                  fontSize: AppTheme.textXs, color: AppTheme.warmGray500,
                                )),
                              ],
                          ...
                          if (note.isNotEmpty) ...[
                            ...
                            Text(note, style: TextStyle(
                              fontSize: AppTheme.textSm, color: AppTheme.warmGray500,
                    ...
                    if (isToday) ...[
                      ...
                      FxInkWell(
                        ...
                        child: Padding(
                          ...
                          child: Icon(Icons.cancel_outlined, size: 18, color: AppTheme.priorityHigh.withValues(alpha: 0.7)),
                        ),
                      ),
                    ],
                  ],
          ...
          Row(
            children: [
              TextButton.icon(
                ...
                icon: Icon(Icons.edit_outlined, size: 18, color: AppTheme.warmGray500),
                label: Text('编辑', style: TextStyle(fontSize: AppTheme.textMd, color: AppTheme.warmGray500)),
              ...
              if (_expandedHabitLogs.isEmpty) ...[
                ...
                TextButton.icon(
                  ...
                  icon: Icon(Icons.delete_outline, size: 18, color: AppTheme.priorityHigh),
                  label: Text('删除', style: TextStyle(fontSize: AppTheme.textMd, color: AppTheme.priorityHigh)),
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                    minimumSize: Size.zero,
                    tapTargetSize: MaterialTapTargetSize.shrinkWrap,
  ...
  Widget _periodLabel(String period) {
    ...
    return Text(label, style: TextStyle(fontSize: AppTheme.textXs, color: AppTheme.warmGray500));
  }
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Center(child: Text('🎯', style: TextStyle(fontSize: 36, height: 1.2))),
          ),
          const SizedBox(height: 24),
          Text(
            '还没有习惯',
            style: TextStyle(
              fontSize: AppTheme.textXl, height: 1.3,
  ...
  Widget _buildHabitCard(Habit habit) {
    ...
    final isAchieved = habit.targetDays > 0 && habit.streakCount >= habit.targetDays;
    ...
    return Column(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: isExpanded ? habitColor.withValues(alpha: 0.4) : AppTheme.warmBorder, width: isExpanded ? 1.5 : 1),
      ...
      child: Material(
        ...
        child: FxInkWell(
            ...
            child: Row(
              children: [
                ...
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: habitColor.withValues(alpha: isAnimating ? 0.2 : 0.1),
          ...
          crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      Text(habit.name, style: TextStyle(
                        fontSize: AppTheme.textLg, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.onSurface, height: 1.3,
                      )),
                      const SizedBox(height: 4),
                      Text(habit.frequencyText, style: TextStyle(color: AppTheme.warmGray500, fontSize: AppTheme.textMd, height: 1.5)),
                    ],
                  ),
                ),
                // 连续天数 pill badge
                if (habit.streakCount > 0)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isAchieved ? AppTheme.priorityLow.withValues(alpha: 0.1) : AppTheme.primaryLight,
                      borderRadius: BorderRadius.circular(9999),
                    ),
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Text(isAchieved ? '🏆' : '🔥', style: TextStyle(fontSize: AppTheme.textMd, height: 1.5)),
                      SizedBox(width: 4),
                      Text(
                        habit.targetDays > 0 ? '${habit.streakCount}/${habit.targetDays}天' : '${habit.streakCount}天',
                        style: TextStyle(fontSize: AppTheme.textMd, height: 1.5, fontWeight: FontWeight.w600,
                          color: isAchieved ? AppTheme.priorityLow : AppTheme.primary,
                        ),
                      ),
                    ]),
                  ),
                ...
                FxInkWell(
                  ...
                  child: Container(
                    width: 36, height: 36,
                    decoration: BoxDecoration(
                      color: AppTheme.warmWhite, shape: BoxShape.circle,
                      border: Border.all(color: AppTheme.warmBorder, width: 1),
                    ),
                    child: Icon(Icons.history, size: 18, color: AppTheme.warmGray500),
                  ),
                ),
                const SizedBox(width: 8),
                // 打卡按钮
                FxInkWell(
                  ...
                  child: AnimatedContainer(
                    ...
                    width: 40, height: 40,
                    decoration: BoxDecoration(
                      color: isAnimating ? habitColor : habitColor.withValues(alpha: 0.1),
                      shape: BoxShape.circle,
                    ),
                    child: Icon(
                      isAnimating ? Icons.check : Icons.check_circle_outline,
                      size: 24, color: isAnimating ? AppTheme.white : habitColor,
                    ),
                  ),
                ),
              ],
        ...
        // 内嵌详情
        if (isExpanded)
          _buildInlineDetail(habit, habitColor),
        SizedBox(height: 12),
      ],
    );
  }
...
class _CreateHabitDialogState extends State<_CreateHabitDialog> {
  ...
  final _icons = ['✅', '💪', '📚', '🏃', '🧘', '💧', '🍎', '💤', '📝', '🎯', '✍️', '🌍'];
  final _colors = ['#52c41a', '#1890ff', '#722ed1', '#eb2f96', '#fa8c16', '#13c2c2', '#f5222d', '#2f54eb'];
  final _periods = [
    {'value': '', 'label': '不限'},
  ...
  void initState() {
    ...
    if (h != null) {
      ...
      if (h.reminderAt.containsKey('hour') && h.reminderAt.containsKey('minute')) {
            ...
            if (_showTemplates) ...[
                ...
                children: _templates.map((t) {
                  return FxInkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: ColorUtils.safeParse(t.color).withValues(alpha: 0.08),
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(color: AppTheme.warmBorder, width: 1),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Text(t.icon, style: const TextStyle(fontSize: AppTheme.textLg, height: 1.3)),
                          const SizedBox(width: 4),
                          Text(
                            t.name,
                            style: TextStyle(
              ...
              Align(
                ...
                child: ShadButton.ghost(
                  ...
                  child: const Text('自定义', style: TextStyle(fontSize: AppTheme.textMd, height: 1.5)),
                ),
              ),
            ],
...
FxInput(
  ...
  autofocus: true,
                ...
                children: _icons.map((icon) {
                  ...
                  return FxInkWell(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Text(icon, style: const TextStyle(fontSize: 24, height: 1.2)),
                    ),
                  );
                }).toList(),
              ),
                  ...
                  return FxInkWell(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: isSelected ? AppTheme.warmDark : Colors.transparent,
              ...
              if (_frequency != 'none') ...[
                ...
                Row(
                  children: [
                    Text('每', style: TextStyle(color: AppTheme.warmGray500, fontSize: AppTheme.textMd)),
                    const SizedBox(width: 8),
                    SizedBox(
                      width: 60,
                      child: FxInput(
                    ...
                    const SizedBox(width: 8),
                    Text(_frequencyUnit, style: TextStyle(color: AppTheme.warmGray500, fontSize: AppTheme.textMd)),
                  ],
                ),
              ],
              // 周几选择
              ...
              if (_loadingTags)
                ...
                Wrap(
                  ...
                  children: [
                    ChoiceChip(
                      ...
                      onSelected: (_) => setState(() => _selectedSystemTagId = null),
                    ),
                    ...{for (final t in _systemTags) t['id']: t}.values.map((tag) {
                      return ChoiceChip(
                        label: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                        ...
                        onSelected: (_) => setState(() => _selectedSystemTagId = tag['id']),
                      );
                    }),
                  ],
                )
                ...
                Padding(
                  ...
                  child: Text(
                    '暂无分类标签，可在“系统标签”页面添加',
                    style: TextStyle(fontSize: AppTheme.textSm, height: 1.5, color: AppTheme.warmGray400),
                  ),
                ),
              const SizedBox(height: 16),
              // 预期时长
              ...
              Row(
                children: [
                  Expanded(child: Text('自动生成每日任务', style: TextStyle(fontSize: AppTheme.textMd, height: 1.5, color: AppTheme.warmGray500))),
                  FxSwitch(
                    value: _generateTask,
              ...
              Row(
                children: [
                  Expanded(
                    child: Text('打卡弹窗', style: TextStyle(fontSize: AppTheme.textMd, height: 1.5, color: AppTheme.warmDark)),
                  ),
                  Text('打卡时弹窗填写日志', style: TextStyle(fontSize: AppTheme.textXs, height: 1.4, color: AppTheme.warmGray500)),
                  const SizedBox(width: 8),
                  FxSwitch(
              ...
              FxInkWell(
                onTap: () async {
                  final time = await _showCustomTimePicker(context, _reminderTime);
                  if (time != null) {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.notifications_none, size: 20, color: AppTheme.warmGray500),
                      ...
                      if (_reminderTime != null)
                        FxInkWell(
                          ...
                          child: Icon(Icons.close, size: 18, color: AppTheme.warmGray400),
                        ),
                    ],
                  ),
                ),
              ...
              Align(
                ...
                child: ShadButton.ghost(
                  ...
                  child: const Text('← 返回模板', style: TextStyle(fontSize: AppTheme.textMd, height: 1.5)),
                ),
              ),
            ],
          ],
      ...
      actions: [
        ShadButton.ghost(onPressed: () => Navigator.pop(context), child: const Text('取消')),
      ],
    );
  }
  ...
  Future<TimeOfDay?> _showCustomTimePicker(BuildContext context, TimeOfDay? initial) async {
            ...
            return AlertDialog(
              ...
              title: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  const Text('选择时间', style: TextStyle(fontSize: AppTheme.textLg, fontWeight: FontWeight.w600)),
                ],
              ),
              content: SizedBox(
                width: 300,
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Text('小时', style: TextStyle(fontSize: AppTheme.textXs, color: AppTheme.warmGray400)),
                    ),
                    const SizedBox(height: 8),
                    Wrap(
                      spacing: 6,
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text('分钟', style: TextStyle(fontSize: AppTheme.textXs, color: AppTheme.warmGray400)),
                    ),
                    const SizedBox(height: 8),
                    Wrap(
                      spacing: 6,
                      runSpacing: 6,
                      children: [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55].map((i) {
              ...
              actions: [
                TextButton(
                  ...
                  child: Text('取消', style: TextStyle(color: AppTheme.warmGray400)),
                ),
                FxButton(
                  label: '确定',
